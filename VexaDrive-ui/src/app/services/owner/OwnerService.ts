...
const OWNER_API_BASE_URL = 'http://localhost:5066/api/Owner'; // adjust port based on launchSettings.json
...
export class OwnerService {
  ...
  // Search owners
  searchOwners(id?: number, firstName?: string, lastName?: string, email?: string, contact?: string): Observable<OwnerDetailsDto[]> {
    const params: any = {};
  ...
  // Get owner by ID
  getOwnerById(ownerId: number): Observable<OwnerDetailsDto> {
